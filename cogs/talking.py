...
choices = ['Bots are objectively better than human',
                           'you know 2 + 2 is 4? Check it',
                           'Disappointed, but not surprised at all',
                           'Would you like to be a bot?',
                           '1, 2, 3, 4, 5...',
                           'Genius at working',
                           'Bot bot bot, superbot',
                           'There is a correlation between number of humans and number of idiots',
                           'Hey, behind you!']
...
class Cleverbot():
    ...
    async def apikey(self, key: str):
        """Sets token for the bot, don't use it."""
